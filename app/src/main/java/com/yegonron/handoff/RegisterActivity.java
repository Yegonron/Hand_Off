...
public class RegisterActivity extends AppCompatActivity {
    ...
    private EditText emailField, usernameField, passwordField, cPasswordField;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerBtn.setOnClickListener(view -> {
            ...
            //get the confirm password entered
            ...
            if (!TextUtils.isEmpty(email) && (Patterns.EMAIL_ADDRESS.matcher(email).matches()) && !TextUtils.isEmpty(username) && !TextUtils.isEmpty(password)
                    && !TextUtils.isEmpty(cPassword) && (password.length() > 6) && (isValidPassword(password))
